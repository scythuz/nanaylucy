        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="owl-carousel hero-slide owl-style">
              ...
              <img src="img/wine_3.png" alt="Image" class="img-fluid">
			  <img src="img/wine_3.png" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-5 ml-auto">
            <h2 class="text-primary">Lambanog Details</h2>
            <p> Lambanog (Philippines Coconut Wine) is wine made from coconut. Lambanog is well-known for its strength that ordinarily carries regarding 80 to 90 proof alternatives. It is mostly produced in the Quezon Province, Philippines. It has certainly been passed down throughout generations of coconut plantation farmers. The procedure includes collecting the sap from the coconut flower, comparable to rubber tree tapping. The sap is then prepared and fermented to turn into tuba, a popular coconut toddy. The tuba is then distilled to make lambanog.</p>

            <div class="mb-5">
              <div class="input-group mb-3" style="max-width: 200px;">
                <div class="input-group-prepend">
                 <h2> Available Sizes: 1000ml and 500ml
                </div>
      ...
      <div class="container">
        <div class="owl-carousel owl-slide-3 owl-slide">
          ...
          <blockquote class="testimony">
            ...
            <p>FDA Approved</p>
            <p class="small text-primary">&mdash; </p>
          </blockquote>
          <blockquote class="testimony">
		  ...
		  <blockquote class="testimony">
            ...
            <p>License No: LTO-3000004347809</p>
            <p class="small text-primary">&mdash;</p>
          </blockquote>
